...
import { footerOption1, footerOption2, footerOption3, footerOption4, regretButton, powered, title, branches, footerContact1, footerContact2, footerContact3, copyrigth } from "../../api"
import Pierce from "../../assets/Pierce.png"
import Vtex from "../../assets/vtex.png"
import fiscalData from "../../assets/fiscalData.png"
    ...
    return (
        <footer className={styles.allFooter}>
            ...
            <section className={styles.leftSide}>
                ...
                <button className={styles.btnregret}>{regretButton}</button>
            </section>
            ...
            <div className={styles.bottomFooter}>
                ...
                <span className={styles.Copyrigth}>{copyrigth}</span>
            </div>
            <figure className={styles.fiscalData}>
            <img src={fiscalData} alt="Data Fiscal" />
            </figure>
            <figure className={styles.vtex}>
            <img src={Vtex} alt="Logo de Vtex"/>
            </figure>
        </footer>
    )
}